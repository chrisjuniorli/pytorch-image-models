    ...
    def __init__(self,
        ...
        if self.use_conv_blocks:
            ...
            if conv_head == 'ir':
                ...
                self.conv_head = EfficientConvHead(embed_dim_in=conv_dim, embed_dim_out=embedding_dim[0], headtype='cc')
            else:
...
@register_model
def ccmlp_b0_ir(pretrained=False, **kwargs):
    model_kwargs = dict(
        num_stage=3, num_blocks=[2,4,2], downsample_rate=8, mlp_ratio=[2,2,2], embedding_dim=[128,256,512], 
        use_conv_blocks=True, conv_head='ir', downsample_type='conv', use_depthconv=True, **kwargs)
    return _create_ccmlp('ccmlp_s', pretrained=pretrained, **model_kwargs)

@register_model
def ccmlp_b0_cc(pretrained=False, **kwargs):
    model_kwargs = dict(
        num_stage=3, num_blocks=[2,4,2], downsample_rate=8, mlp_ratio=[2,2,2], embedding_dim=[128,256,512], 
        use_conv_blocks=True, conv_head='cc', downsample_type='conv', use_depthconv=True, **kwargs)
    return _create_ccmlp('ccmlp_s', pretrained=pretrained, **model_kwargs)

@register_model
def ccmlp_b0_ch(pretrained=False, **kwargs):
    model_kwargs = dict(
        num_stage=3, num_blocks=[2,4,2], downsample_rate=8, mlp_ratio=[2,2,2], embedding_dim=[128,256,512], 
...
def ccmlp_s_v3_baseline(pretrained=False, **kwargs):
    model_kwargs = dict(
        num_stage=4, num_blocks=[2,2,4,2], downsample_rate=4, mlp_ratio=[2,2,2,2], embedding_dim=[64,128,256,512], use_conv_blocks=False, **kwargs)
    return _create_ccmlp('ccmlp_s', pretrained=pretrained, **model_kwargs)
...
@register_model
def ccmlp_b0_baseline(pretrained=False, **kwargs):
    model_kwargs = dict(
        num_stage=4, num_blocks=[2,2,4,2], downsample_rate=4, mlp_ratio=[2,2,2,2], embedding_dim=[64,128,256,512], 
        use_conv_blocks=False, **kwargs)
    return _create_ccmlp('ccmlp_b0', pretrained=pretrained, **model_kwargs)
...
@register_model
def ccmlp_b1_baseline(pretrained=False, **kwargs):
    model_kwargs = dict(
        num_stage=4, num_blocks=[3,3,6,3], downsample_rate=4, mlp_ratio=[3,3,3,3], embedding_dim=[64,128,256,512], 
...
def ccmlp_b3(pretrained=False, **kwargs):
    model_kwargs = dict(
        num_stage=3, num_blocks=[5,10,3], downsample_rate=8, mlp_ratio=[4,4,4], conv_dim=96, embedding_dim=[192,384,768], 
        use_conv_blocks=True, num_conv_block=3, downsample_type='conv', use_depthconv=True, **kwargs)
