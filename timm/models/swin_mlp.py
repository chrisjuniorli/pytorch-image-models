...
default_cfgs = {
    ...
    'swin_mlp_base_patch4_window7_224': _cfg(
        url='',
...
def _create_swin_mlp(variant, pretrained=False, default_cfg=None, **kwargs):
...
@register_model
def swin_mlp_base_patch4_window7_224(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
    return _create_swin_mlp('swin_mlp_base_patch4_window7_224', pretrained=pretrained, **model_kwargs)
