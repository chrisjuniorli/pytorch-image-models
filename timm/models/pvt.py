...
def pvt_tiny(pretrained=False, **kwargs):
    model = PyramidVisionTransformer(
        ...
        **kwargs)
    model.default_cfg = _cfg(url='https://github.com/whai362/PVT/releases/download/v2/pvt_tiny.pth')
...
def pvt_small(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg(url='https://github.com/whai362/PVT/releases/download/v2/pvt_small.pth')
