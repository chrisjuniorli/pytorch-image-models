...
default_cfgs = {
    'shuffle_vit_base_patch4_window7_224_local7midV2': _cfg(
        url='',
...
def _create_shuffle_swin_transformer(variant, pretrained=False, default_cfg=None, **kwargs):
    ...
    model = build_model_with_cfg(
        ShuffleTransformer, variant, pretrained,
...
@register_model
def shuffle_vit_base_patch4_window7_224_local7midV2(pretrained=False, **kwargs):
    """ Swin-B @ 384x384, pretrained ImageNet-22k, fine tune 1k
    """
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
    return _create_shuffle_swin_transformer('shuffle_vit_base_patch4_window7_224_local7midV2', pretrained=pretrained, **model_kwargs)